...
func TestReconciled(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			// Test TaskRun
			taskRun := objects.NewTaskRunObject(&v1.TaskRun{
			...
			cachedTaskRun := objects.NewTaskRunObject(&v1.TaskRun{
				ObjectMeta: metav1.ObjectMeta{
					Annotations: map[string]string{
			...
			// Test PipelineRun
			pipelineRun := objects.NewPipelineRunObject(&v1.PipelineRun{
				ObjectMeta: metav1.ObjectMeta{
					Annotations: map[string]string{
						ChainsAnnotation: tt.annotation,
					},
			...
			cachedPipelineRun := objects.NewPipelineRunObject(&v1.PipelineRun{
				ObjectMeta: metav1.ObjectMeta{
					Annotations: map[string]string{
						ChainsAnnotation: tt.latestAnnotation,
					},
...
func TestMarkSigned(t *testing.T) {
	tests := []struct {
		...
		{
			name: "mark taskrun",
			object: objects.NewTaskRunObject(&v1.TaskRun{
				ObjectMeta: metav1.ObjectMeta{
					Name: "my-taskrun",
				},
				Spec: v1.TaskRunSpec{
		...
		},
		{
			...
			object: objects.NewPipelineRunObject(&v1.PipelineRun{
				ObjectMeta: metav1.ObjectMeta{
					Name: "my-pipelinerun",
				},

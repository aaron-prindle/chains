	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			...
			runObjects := []objects.TektonObject{
				createTaskRunObjectV1Beta1WithResults(tc.results),
			...
			for _, o := range runObjects {
				...
				gotURIs := extractv1beta1.RetrieveAllArtifactURIs(ctx, o, false)
...
func createTaskRunObjectV1Beta1WithResults(results map[string]string) objects.TektonObject {
	...
	return objects.NewTaskRunObjectV1Beta1(
		&v1beta1.TaskRun{
...
func createProWithPipelineResults(results map[string]string) objects.TektonObject {
	...
	return objects.NewPipelineRunObjectV1Beta1(
		&v1beta1.PipelineRun{
...
//
//nolint:all
func createProWithTaskRunResults(pro *objects.PipelineRunObjectV1Beta1, results []artifact) objects.TektonObject {
	if pro == nil {
